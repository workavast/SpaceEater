...
{
    public sealed class GameCycleController : IGameCycleController, IGameCycleSwitcher
    {
        ...
        public void Initialize(GameCycleState initialState)
        {
        ...
        public void ManualUpdate(float deltaTime)
            => _actions[CurrentState][GameCycleInvokeType.Update]?.Invoke();
        
        public void ManualFixedUpdate(float fixedDeltaTime) 
            => _actions[CurrentState][GameCycleInvokeType.FixedUpdate]?.Invoke();
